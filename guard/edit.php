...
if($_GET['id']) {
    ...
    $sql = "SELECT * FROM butiran WHERE id = {$id}";
...
<fieldset>
    ...
    <form action="update.php" method="post">
        <table cellspacing="0" cellpadding="0">
            <tr>
                <th>NAMA</th>
                <td><input type="text" name="username" value="<?php echo $data['nama'] ?>" /></td>
            </tr>     
            <tr>
                <th>KATA LALUAN</th>
                <td><input type="text" name="pass" value="<?php echo $data['no_tel'] ?>" /></td>
            </tr>
            <tr>
                <th>BANGSA</th>
                <td><input type="text" name="pass" value="<?php echo $data['bangsa'] ?>" /></td>
            </tr>
            <tr>
            <tr>
