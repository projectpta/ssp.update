...
<h2>
   ...
   <button onClick="location.href='aras1_2_3.php'">BLOK A</button>
  <button>B-A-1-2</button>
  <button>B-A-1-3</button>
  <button>B-A-1-4</button>
  <button>B-A-1-5</button>
  <button>B-A-1-6</button>
  <button>B-A-1-7</button>
  <button>B-A-1-8</button>
...
<div class="panel">
  ...
  <button>B-A-3-1</button>
  <button>B-A-3-2</button>
  <button>B-A-3-3</button>
  <button>B-A-3-4</button>
  <button>B-A-3-5</button>
  <button>B-A-3-6</button>
  <button>B-A-3-7</button>
  <button>B-A-3-8</button>
